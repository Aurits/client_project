...
if (mysqli_num_rows($result) > 0) {
  ...
  $product_image3 = $row['product_image_three'];
  $product_image4 = $row['product_image_four'];
      ...
      <div class="p-l-25 p-r-30 p-lr-0-lg">
        <div class="wrap-slick3 flex-sb flex-w">
          ...
          <div class="slick3 gallery-lb">
            <div class="item-slick3" data-thumb="site_images/<?php echo htmlspecialchars($product_image); ?>">
              <div class="wrap-pic-w pos-relative">
                <img src="site_images/<?php echo htmlspecialchars($product_image); ?>" alt="IMG-PRODUCT" />

                <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="site_images/<?php echo htmlspecialchars($product_image); ?>">
                  <i class="fa fa-expand"></i>
                </a>
              </div>
            </div>
            <div class="item-slick3" data-thumb="site_images/<?php echo htmlspecialchars($product_image2); ?>">
              <div class="wrap-pic-w pos-relative">
                <img src="site_images/<?php echo htmlspecialchars($product_image_two); ?>" alt="IMG-PRODUCT" />
                <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="site_images/<?php echo htmlspecialchars($product_image2); ?>">
                  <i class="fa fa-expand"></i>
                </a>
              </div>
            </div>

            <div class="item-slick3" data-thumb="site_images/<?php echo htmlspecialchars($product_image3); ?>">
              <div class="wrap-pic-w pos-relative">
                <img src="site_images/<?php echo htmlspecialchars($product_image3); ?>" alt="IMG-PRODUCT" />
                <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="site_images/<?php echo htmlspecialchars($product_image3); ?>">
                  <i class="fa fa-expand"></i>
                </a>
              </div>
            </div>
